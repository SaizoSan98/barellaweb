...
export function HeroBackground() {
  ...
  // Disable background on mobile to prevent main thread blocking
  ...
  return (
    <div ref={ref} className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      >
        {/* On Mobile: Just a simple static dark background or simple gradient */}
        ...
        {/* On Desktop: Full Animated Experience */}
