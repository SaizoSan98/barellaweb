...
export default async function SutiKezelesPage() {
  const [page, settingsRows] = await Promise.all([
    db.select().from(legalPages).where(eq(legalPages.slug, 'suti-kezeles')).limit(1),
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-8">
          {legalPage?.title || "Süti kezelési tájékoztató"}
        </h1>
